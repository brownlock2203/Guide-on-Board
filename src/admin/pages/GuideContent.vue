            ...
            <!-- The menu -->
                ...
                <div v-for="(section, key) in sections" :key="section.id" >
                    ...
                    <div v-if="sectionId === section.id && step" class="flex justify-between ml-[100px] pl-[30px] pr-[50px] py-[10px] flex items-center mt-[15px]">
                        ...
                        <!-- Folder and Section Name -->
                        <div class="flex flex-row items-center space-x-4">
                            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 102.17 122.88" class="w-8 h-8 hover:cursor-pointer hover:opacity-70" @click="redirect">
...
const redirect = () => {
    ...
    const editLink = `http://monplugin.local/wp-admin/post.php?post=${sectionId}&action=edit`;
